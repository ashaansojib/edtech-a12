    ...
    return (
        <nav className="navbar my-container border-b dark:bg-gray-800 dark:text-white">
            <div className="navbar-start">
                ...
                <Link to="/">Best English Lerning</Link>
            </div>
            ...
            <div className="navbar-end">
                {/* <label className="swap swap-rotate">
                    <input type="checkbox" onChange={handleToggle} checked={theme === "light" ? false : true} className='hidden ' />
                ...
                {
                    user ? <button onClick={handleLogOut} className='active'>Sign Out</button> :
